...
<script lang="ts">
  ...
  async function signInWithGoogle() {
    ...
    // No need to redirect manually as Supabase will handle the redirect
  }
...
<div class="flex min-h-screen items-center justify-center px-4 py-12 bg-gradient-to-b from-background to-muted/30">
<Card class="w-full max-w-md shadow-lg border-muted">
  ...
  <CardContent>
    ...
    >
      ...
      {:else}
        <svg viewBox="0 0 24 24" width="16" height="16" xmlns="http://www.w3.org/2000/svg" class="mr-2">
    ...
    <form on:submit|preventDefault={handleLogin} class="space-y-4">
      ...
      <div class="space-y-2">
        ...
        <div class="flex justify-end">
          <a href="/auth/reset-password" class="text-xs text-primary hover:underline hover:text-primary/90">
            Forgot password?
          </a>
        </div>
      </div>
